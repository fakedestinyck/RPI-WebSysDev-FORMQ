...
if (!$user_exists) {
    ...
    $document = array(
        "user" => array("user_id" => $id, "name" => "", "rin" => 0, "rcsid" => $rcsid, "role" => 2, "email" => "", "in_group" => "no", "reported" => "no", "requested_group"=>-1),
        "group" => array("group_id" => $id, "name" => "", "current_num" => 1, "desired_num" => 0,
            "group_members" => array("member1" => $rcsid, "member2" => "", "member3" => "", "member4" => "", "member5" => "", "member6" => "", "member7" => "", "member8" => "", "member9" => "", "member10" => ""),
            "group_answers" => array("q1" => "", "q2" => "", "q3" => "", "q4" => "", "q5" => "", "q6" => 0, "q7" => 0, "q8" => 0, "q9" => 0, "q10" => 0, "q11" => 0, "q12" => 0, "notes" => "")
        ),
        "profile" => array("age" => 0, "year" => 0, "budget" => 0, "number" => 1, "gender" => "", "coed" => "", "on/off campus" => ""),
        "answers" => array("q1" => "", "q2" => "", "q3" => "", "q4" => "", "q5" => "", "q6" => 0, "q7" => 0, "q8" => 0, "q9" => 0, "q10" => 0, "q11" => 0, "q12" => 0, "notes" => "")
    );
